...
nmap  o
nnoremap  :BuffergatorMruCycleNext
nnoremap  :BuffergatorMruCyclePrev
nnoremap  {( | zz
nmap o <Plug>ZoomWin
nnoremap e :TabooOpen
nnoremap q :tabclose!
...
vmap \tr :call Turkish_Deasciify()
nnoremap <silent> \c :CloseBuffers
map \n :NERDTreeToggle
nnoremap <silent> \x :Goyo
nnoremap \u :GitGutterToggle
nnoremap \sv :source $MYVIMRC
nnoremap \ez :vsp ~/.zshrc
nnoremap \ev :vsp $MYVIMRC
nnoremap <silent> \z :ZoomWin
nnoremap \h :nohl
nnoremap \k :Limelight!
...
nnoremap \w :w|:Bclose!
nnoremap \on :only
nnoremap \re :set relativenumber!
...
set pyxversion=2
set ruler
set runtimepath=~/.vim,~/.vim/plugged/base16-vim/,~/.vim/plugged/vim-tmux-navigator/,~/.vim/plugged/python-mode/,~/.vim/plugged/vim-buffergator/,~/.vim/plugged/taboo.vim/,~/.vim/plugged/nerdtree/,~/.vim/plugged/nerdtree-git-plugin/,~/.vim/plugged/jedi/,~/.vim/plugged/Vim-Jinja2-Syntax/,~/.vim/plugged/vim-session/,~/.vim/plugged/vim-misc/,~/.vim/plugged/ack.vim/,~/.vim/plugged/vim-colorschemes/,~/.vim/plugged/limelight.vim/,~/.vim/plugged/goyo.vim/,~/.vim/plugged/vim-surround/,~/.vim/plugged/bclose.vim/,~/.vim/plugged/vim-tmux/,~/.vim/plugged/fzf.vim/,~/.vim/plugged/vim-gitgutter/,~/.vim/plugged/indentpython.vim/,~/.vim/plugged/vim-flake8/,~/.vim/plugged/syntastic/,~/.vim/plugged/syntastic-extras/,~/.vim/plugged/vim-easymotion/,~/.fzf/,~/.vim/plugged/delimitMate/,~/.vim/plugged/YouCompleteMe/,~/.vim/plugged/turkish-deasciifier.vim/,~/.vim/plugged/vim-diminactive/,~/.vim/plugged/Dockerfile.vim/,~/.vim/plugged/close-buffers.vim/,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim80,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/python-mode/after,~/.vim/after
...
let NERDTreeBookmarksFile = "/home/orkung/.NERDTreeBookmarks"
...
silent only
cd ~/Git_Repolari/kisisel/public/belgeler/calismalar/tmpreader_tmpwatch_usage
...
exe 'vert 1resize ' . ((&columns * 39 + 89) / 179)
exe 'vert 2resize ' . ((&columns * 139 + 89) / 179)
argglobal
let s:cpo_save=&cpo
set cpo&vim
